...
public class NetService {
    ...
    public static  <S> void init(String baseUrl, Class<S> service) {
        mDefaultUrl = baseUrl;
        mService = service;
    }
    ...
    private OkHttpClient createClient(NetConfig netConfig) {
    ...
    private String readAppKey() {
        try {
            ApplicationInfo appInfo = BaseUtil.getContext().getPackageManager()
                    .getApplicationInfo(BaseUtil.getContext().getPackageName(), PackageManager.GET_META_DATA);
            if (appInfo != null) {
