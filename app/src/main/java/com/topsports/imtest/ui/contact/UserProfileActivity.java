    ...
    private void findViews() {
        ...
        aliasLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //进入备注名页面
                ToastUtil.showLongToast("进入备注名页面");
//                UserProfileEditItemActivity.startActivity(UserProfileActivity.this, UserConstant.KEY_ALIAS, account);
    ...
    private void initActionbar() {
        ...
        if (!UserManager.getInstance().getLoginInfo().getAccount().equals(account)) {
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToastUtil.showLongToast("进入用户信息设置页面");
//                UserProfileSettingActivity.start(UserProfileActivity.this, account);
    ...
    private void updateToggleView() {
        if (UserManager.getInstance().getLoginInfo().getAccount() != null && !UserManager.getInstance().getLoginInfo().getAccount().equals(account)) {
    ...
    private void doAddFriend(String msg, boolean addDirectly) {
        ...
        if (!TextUtils.isEmpty(account) && account.equals(UserManager.getInstance().getLoginInfo().getAccount())) {
