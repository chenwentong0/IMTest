package com.topsports.imtest.ui.common.browser;
...
import com.topsports.imtest.MyApplication;
...
public class FileBrowserViewHolder extends TViewHolder {
    ...
    protected void inflate() {
        directoryBitmap = BitmapFactory.decodeResource(MyApplication.getContext().getResources(), R.drawable.directory);
        fileBitmap = BitmapFactory.decodeResource(MyApplication.getContext().getResources(), R.drawable.file);
