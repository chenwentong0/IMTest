package com.topsports.imtest.helper;
...
import com.topsports.imtest.ui.session.extension.CustomAttachParser;
import com.topsports.imtest.ui.session.extension.GuessAttachment;
import com.topsports.imtest.ui.session.extension.MsgViewHolderFile;
import com.topsports.imtest.ui.session.extension.MsgViewHolderSticker;
import com.topsports.imtest.ui.session.extension.StickerAttachment;
import com.topsports.imtest.ui.session.viewholder.MsgViewHolderAVChat;
import com.topsports.imtest.ui.session.viewholder.MsgViewHolderGuess;
...
//        if (!TextUtils.equals(UserManager.getInstance().getLoginInfo().getAccount(), account)) {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                if (message.getMsgType() == MsgTypeEnum.robot && message.getDirect() == MsgDirectionEnum.In) {
                    ...
                    if (attachment.isRobotSend()) {
                        ToastUtil.showLongToast("进入机器人页面");
...
//                AckMsgInfoActivity.start(context, message);
                ToastUtil.showLongToast("已读回执事件处理");
            }
        };
